...
.sparse_sim <- function(path, nugget, w_, Bi_, KMi_, maxvar, K_, d_, yTR, vTR, discount_noise, Q_, smooth, randnum, reg = 1e-6) {
    .Call('_geomod3D_sparse_sim', PACKAGE = 'geomod3D', path, nugget, w_, Bi_, KMi_, maxvar, K_, d_, yTR, vTR, discount_noise, Q_, smooth, randnum, reg)
}
